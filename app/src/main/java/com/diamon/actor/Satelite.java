...
public class Satelite extends Actor
{
	...
	public final static int DIRECCION_ADELANTE = 3;

	public final static int DIRECCION_ATRAS = 4;
	...
	public Satelite(Pantalla pantalla, Textura[] texturas, float x, float y, float ancho, float alto,
	...
	private void disparar()
	{
		...
		BalaInteligente bala = new BalaInteligente(pantalla, recurso.getTextura("balaSatelite.png"), x, y + 4, 8, 8);

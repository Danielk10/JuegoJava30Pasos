...
public class Volador extends Actor {
    ...
    public static final float VELOCIDAD_MAQUINA = 2f;
        ...
        y =
                (float)
                        (pocicionY
                                + distanciaMovimiento
                                + (distanciaMovimiento
                                        * Math.sin(Math.toDegrees(tiempo * velocidad))));
    ...
    public void disparar() {
        ...
        bala.setVelocidad(
                direccionX * BalaEnemigo.VELOCIDAD_BALA, direccionY * BalaEnemigo.VELOCIDAD_BALA);
